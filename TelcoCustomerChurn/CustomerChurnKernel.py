# coding=utf-8
"""Telco customer churn dataset classifier kernel."""
...
def load_dataset(path="tcc.csv", verbose=True):
    print("Loading data...")
...
def split_dataset(dataset):
    ...
    X = dataset.drop(['Churn', 'customerID', 'SeniorCitizen', 'tenure', 'MonthlyCharges', 'TotalCharges'], axis=1)
    y = dataset['Churn']
    z = dataset[['SeniorCitizen', 'tenure', 'MonthlyCharges', 'TotalCharges']]
    return X, y, z
