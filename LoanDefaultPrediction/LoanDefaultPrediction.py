# coding=utf-8
"""Credit Department Dataset on Loan Defaulting.
"""
...
def load_dataset(path="hmeq.csv", verbose=True):
    print("Loading data...")
...
def split_dataset(dataset):
    ...
    X = dataset.drop(['BAD', 'REASON', 'JOB'], axis=1)
    y = dataset['BAD']
    z = dataset[['REASON', 'JOB']]
    return z, y, X
...
if __name__ == "__main__":
    ...
    model = ExtraTreesClassifier(n_estimators=300, max_depth=None, min_samples_split=2)
